var suggestions = function(){
    return {
        defaultOptions:{
            ...
            filterPositive: "",
            lang: "",
            prefixes: [" ", "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "y", "x", "y", "z", "comment", "quel", "pourquoi", "où", "qui", "quand", "est-ce", "que"],
            rateLimit: 750,
            service: "google",
            suffixes: [" ", "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "y", "x", "y", "z", "comme", "pour", "sans", "avec", "versus", "vs", "vers", "près de", "sauf"]
        },
